...
class BrandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create brand" do
    assert_difference('Brand.count') do
      post brands_url, params: { brand: { category_id: @brand.category_id, name: @brand.name } }
    end
  ...
  test "should update brand" do
    patch brand_url(@brand), params: { brand: { category_id: @brand.category_id, name: @brand.name } }
